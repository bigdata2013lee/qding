...
$.fn.zabuto_calendar = function (options) {
    ...
    this.each(function () {
        ...
        function appendMonthHeader($calendarElement, $tableObj, year, month) {
            ...
            var $currMonthLabel = $('<span style="line-height:30px;">' + year + '年' + ' ' + monthLabels[month]  + '</span>');
                ...
                for (var dow = 0; dow < 7; dow++) {
                    if (dow < firstDow || currDayOfMonth > lastDayinMonth) {
                        ...
                        if ($calendarElement.data('showToday') === true && isToday(year, month, currDayOfMonth)) {
                            $dayElement.html('<span class="badge badge-info">' + currDayOfMonth + '</span>');
                        } else {
                            $dayElement.html('<span class="">' + currDayOfMonth + '</span>');
                        }
