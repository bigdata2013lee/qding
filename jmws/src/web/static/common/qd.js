(function($) {
	...
	qd.notify = {
		success: function(msg, delay) {
			$('.notifications').notify({ type: 'success', message: msg, fadeOut: {enabled: true,delay: delay || 4000}}).show();
		},
		info: function(msg, delay) {
			$('.notifications').notify({ type: 'info', message: msg, fadeOut: {enabled: true,delay: delay || 4000} }).show();
		},
		error: function(msg, delay) {
			$('.notifications').notify({ type: 'danger', message: msg, fadeOut: {enabled: true,delay: delay || 4000} }).show();
		}
	};
